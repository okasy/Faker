...
class Text extends \Faker\Provider\Text
{
    ...
    /**
     * 1文節20文字以下になるようにデリミタを設定する。可能なら更に短くできるよう設定する。
     * @var string
     */
...
EOT;
     ...
     * @return string
     */
    protected function _getTexts($maxNbChars, $indexSize = 1)
    {
        if ($maxNbChars < 10) {
     ...
     * @return array
     */
    protected static function split($text)
    {
